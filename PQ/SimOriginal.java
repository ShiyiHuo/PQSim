...
public static void main(String argv[]) {
 ...
 // RouterArrivalRate = Double.parseDouble(argv[1]);
  ...
  SIGMA                = 0.6; TotalCustomers  = 200000;
  ...
  while(NumberOfDepartures < TotalCustomers ) {
	...
	System.out.println("Before entering priority queue, out ot order rate is "+unOrderedCount/200000.0);
...
//	System.out.println("");
	...
	System.out.println("the average package delay is "+(TotalDelay/200000.0));
	System.out.println("the ratio of dropped packets is "+(dropped/200000.0));
