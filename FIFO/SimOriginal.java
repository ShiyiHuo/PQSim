...
public static void main(String argv[]) {
 ...
 // RouterArrivalRate = Double.parseDouble(argv[1]);
  ...
  MeanInterArrivalTime = 1.0/1150; MeanServiceTime = 1/RouterServiceRate;
  SIGMA                = 0.6; TotalCustomers  = 100000;
...
//	HighQueue.enqueue(e);
  ...
  while(NumberOfDepartures < TotalCustomers ) {
	...
	System.out.println("the ratio of out of order packets is "+unOrderedCount/100000.0);
	System.out.println("the average package delay is "+(TotalDelay/100000.0));
	System.out.println("the ratio of dropped packets is "+(dropped/100000.0));
	System.out.println("max queue length is "+MaxQueueLength);
	System.out.println("Avg wait time is "+totalWait/100000.0);
